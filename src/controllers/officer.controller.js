...
class OfficerController {
  ...
  static async getAll(req, res, next) {
    try {
      const result = await OfficerService.getAll(req.query);
  ...
  static async update(req, res, next) {
    try {
      const result = await OfficerService.update(req.params.id, req.body);
  ...
  static async deactivate(req, res, next) {
    try {
      const result = await OfficerService.deactivate(req.params.id);
